...
// Premium studios hub page

import React, { useState } from 'react';
import { Helmet } from 'react-helmet-async';
import { FiStar, FiAward, FiFilm } from 'react-icons/fi';
      ...
      <div className="min-h-screen bg-dark-400">
        ...
        ">
          ...
          <div className="container-site relative z-10 text-center">
            ...
            <h1 className="
              text-3xl sm:text-4xl font-black text-white mb-3
              tracking-tight
            ">
              Premium Studios
            </h1>
            ...
            {/* Filter tabs */}
            <div className="inline-flex items-center gap-2 p-1 rounded-xl bg-white/5 border border-white/8">
              {['all', 'featured'].map((f) => (
                <button
                  key={f}
                  onClick={() => setFilter(f)}
          ...
          ">
            {filtered.map((studio, i) => (
              ...
              >
                {/* Gradient bg */}
                <div
                  className="absolute inset-0 transition-opacity duration-300 group-hover:opacity-100 opacity-85"
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `radial-gradient(circle at 25% 50%, rgba(255,255,255,0.4) 0%, transparent 60%)`,
                  }}
                />
                ...
                ">
                  <span className="
                    font-black text-white text-sm sm:text-base
                    text-shadow leading-tight mb-1.5
